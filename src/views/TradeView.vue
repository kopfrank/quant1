  ...
  <div>
    <div class="table-container">
      <el-table :data="paginatedData" border>
        ...
        <el-table-column prop="date" label="操作日期" min-width="100">
          <template #default="scope">
